            ...
            <div class="row">
                <div class="col-lg-7 mb-5">
                    <div class="contact-form">
                        <div id="success">  </div>
                        <form action="BD/contactBD.php" method="post">
                        ...
                        <?php } ?>
                            ...
                            <div class="control-group">
                                <input type="text" class="form-control" id="name" name="nom" placeholder="Your Name" required="required" data-validation-required-message="Please enter your name" />
                            ...
                            <div class="control-group">
                                <textarea class="form-control" rows="6" id="message" name="mess"placeholder="Message" required="required" data-validation-required-message="Please enter your message"></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div>
                                <button class="btn btn-primary py-2 px-4" type="submit" id="sendMessageButton" name="envoyer">Send Message</button>
                            </div>
                        </form>
                ...
                <div class="col-lg-5 mb-5">
                    <p>Project developed by a young student for a kindergarten 
                        <div class="d-flex">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="pl-3">
                            <h5>Email</h5>
                            <p><a href="mailto:maissaellouze02@gmail.com">maissaellouze02@gmail.com</a></p>
                        </div>
                    </div>
                    <div class="d-flex">
